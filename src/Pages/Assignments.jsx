const Assignments = () => {
  return (
    <div>
      ...
      <div>
        <a
          href="https://github.com/Kyle-Lawrenson/DrumkitChallenge"
          target="_blank"
        >
        ...
        <a
          ...
          target="_blank"
        >
          Drumkit Assignment Live Link.
        </a>
      </div>

      <div>
        <a
          href="https://github.com/Kyle-Lawrenson/keyCodeChallenge"
          target="_blank"
        >
          Keycode Assignment Repository.
        </a>
        <a
          href="https://kyle-lawrenson.github.io/keyCodeChallenge/"
          target="_blank"
        >
          Keycode Assignment Live Link.
        </a>
      </div>

      <div>
        <a
          href="https://github.com/Kyle-Lawrenson/website_clone_assignment"
          target="_blank"
        >
        ...
        <a
          ...
          target="_blank"
        >
          Website Clone Assignment Live Link.
        </a>
      </div>

      <div>
        <a
          href="https://github.com/Kyle-Lawrenson/flexboxNavBarChallenge"
          target="_blank"
        >
