...
<div class="knowledge">
    ...
    <div class="maya">
        ...
        <h3>MAYA</h3> <a
            ...
            target="_blank"> <img className="logo" src={IMAGES.image1} alt="MAYA Logo"/></a>
    </div>
    ...
    <div class="photoshop">
        ...
        <h3>Photoshop</h3> <a
            ...
            target="_blank"><img className="logo" src={IMAGES.image2} alt="Photoshop Logo" /></a>

    </div>

    <div class="ue4">

        <h3>Unreal Engine 4</h3> <a href="https://www.unrealengine.com/en-US" target="_blank"><img className="logo02" src={IMAGES.image3} alt="Unreal Engine 4 logo" /></a>
    </div>
